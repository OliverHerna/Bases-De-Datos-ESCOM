...
You will find below all non-trivial code snippets(recortes) from the above chapter
...
END;
/
rem triger modificado  ------------------   ssl 2020/12/10
...
BEGIN
   check_date (:new.hire_date);
   dbms_output.put_line('Hola ESCOM checando fecha');
      dbms_output.put_line
		('Estoy en clase Remota de ESCOM------------');
   check_email (:new.email);
   dbms_output.put_line('Hola ESCOM checando email');
END;
/
-- -----------------------------------------------------------------
...
-- -----------------------------------------------------------------------
REM
REM      TRIGGER MODIFICADO  SSL 2020/12/10 curso distributed
REM
CREATE OR REPLACE TRIGGER bef_ins_ceo_comp
   BEFORE INSERT
   ON ceo_compensation
...
BEGIN
   INSERT INTO ceo_comp_history
    ...
    dbms_output.put_line
				('Hola ESCOM checando compensacion ');
    dbms_output.put_line
				('Estoy en clase Remota de ESCOM------------');
   COMMIT;
END;
...
BEGIN
   NULL;
    dbms_output.put_line
				('Hola ESCOM checando ACTUALIZACION DE SALARIO ');
    dbms_output.put_line
				('Estoy en clase Remota de ESCOM------------');
END;
/
...
END;
/
rem lineas de comentarios en ejecución
rem 
dbms_output.put_line('Hola ESCOM checando fecha');
      dbms_output.put_line
		('Estoy en clase Remota de ESCOM------------');