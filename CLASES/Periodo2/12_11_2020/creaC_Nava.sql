...
( Essn            VARCHAR2(9)     constraint works_on_essn_nn    NOT NULL,
  ...
  Hours           NUMBER(4,1)     constraint works_on_hours_nn   NOT NULL);
-- ,
...
( Essn            VARCHAR2(9)     constraint dependent_essn_nn       NOT NULL,
  ...
  Sex             VARCHAR2(1)     constraint dependent_Sex_check check (sex in('M', 'F')),
  Bdate           DATE,
  Relationship    VARCHAR2(8)     constraint dependent_Relat_check check
										    (Relationship in('Daugther', 'Son','Spouse'))
  );
--  ,
...
ALTER TABLE DEPARTMENT
		ADD CONSTRAINT DEPART_EMPLO_FK	 	  FOREIGN KEY (Mgr_ssn) REFERENCES EMPLOYEE(Ssn);
...
ALTER TABLE DEPT_LOCATIONS
		ADD CONSTRAINT DEPT_LOCATIONS_DEPT_FK    FOREIGN KEY (Dnumber) REFERENCES DEPARTMENT(Dnumber);
...
ALTER TABLE PROJECT
		ADD CONSTRAINT PROJECT_DEPART_FK  	FOREIGN KEY (Dnum) REFERENCES DEPARTMENT(Dnumber)
...
ALTER TABLE WORKS_ON
		...
		ADD CONSTRAINT WORKS_ON_EMP_FK 	  	FOREIGN KEY (Essn) REFERENCES EMPLOYEE(Ssn)
...
ALTER TABLE DEPENDENT
		...
		ADD CONSTRAINT DEPENDENT_EMP_FK       FOREIGN KEY (Essn) REFERENCES EMPLOYEE(Ssn);
